...
class AlertaController extends Controller
{
    ...
    private function createCreateForm(Alerta $entity)
    {
        ...
        $form->add('button', 'submit', array('label' => 'Volver a la lista','attr'=>array('formaction'=>'../alerta','formnovalidate'=>'formnovalidate','class'=>'btn btn-default col-md-2 col-md-offset-1')));
